...
- **Configurable embedding session timeout** ([qmd#609](https://github.com/tobi/qmd/issues/609), [qmd#673](https://github.com/tobi/qmd/issues/673)) — expose `QMD_EMBED_MAX_DURATION_MS` – already in gmd as CUE config knob.
...
- **Daemon-aware CLI fast-path** ([qmd#608](https://github.com/tobi/qmd/pull/608)) — ~4× speedup by reusing a running daemon's model process.
